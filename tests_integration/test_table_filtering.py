...
class TestTableFiltering(BaseTableTestCase):
    @staticmethod
    def apply_enum_filter(page, column: str, value: str):
        pl = PageLocator(page)
    ...
    @staticmethod
    def apply_range_filter(page, column: str, min_value: str, max_value: str):
        pl = PageLocator(page)
        pl.column_stats_cell(column).click()
        card = pl.column_stats_card(column)
        card.scroll_into_view_if_needed()
    ...
    @staticmethod
    def apply_text_filter(page, column: str, value: str):
        pl = PageLocator(page)
    ...
    @staticmethod
    def assert_filter_count(page, count: int):
        pl = PageLocator(page)
